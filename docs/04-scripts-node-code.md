Aqui estão os scripts em Json usados para auxiliar o workflow. Para ser sincero, eu não sei nada de JavaScript, estou no básico de Python, mas como a versão do n8n para Python está em beta, não quis arriscar. Então pedi para o Claude me gerar os códigos e funcionaram bem.
