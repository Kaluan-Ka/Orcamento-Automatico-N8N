...
![worklfow Principal](../assets/imagens/workflow-principal.png)
...
![imagem edit field](../assets/imagens/edit-field-principal.png)
...
As três tools seguintes são os sub workflows. Como explicado em [01 - visao geral](01-visao-geral.md)
o Agente principal nao sabe de nada, sua única função é interagir com o usuário e chamar as tools correspondentes para ter as informações, registrar e confirmar.

O protocolo de comunicação entre os workflows você irá encontrar em [03 - comunicacao multi agents](03-com-multi-agents.md)

A estrutura dos prompts voce ira encontrar em [06 - prompts](06prompt.md)
...
![imagem subworflow consulta precos](../assets/imagens/subworklow-consulta.png)


O gatilho aqui é o “When executed by another workflow”, ou seja, quando o agente principal aciona esse subworkflow.


![print da trigger](../assets/imagens/trigger-subworkflow.png)
...
![imagem subworkflow registro de presupuesto](../assets/imagens/subworkflow-registro.png)


O gatilho aqui é o “When executed by another workflow”, ou seja, quando o agente principal aciona esse subworkflow.

Agora atenção, entenda que o Agente Principal chama o subworkflow com uma string, em [05 - erros e solucoes](05-erros-e-solucoes.md) eu explico o porquê  isso é um problema na hora que o Agente Registro manda esses dados para tabela “Info_Presupuesto”. Então existe a necessidade de fazer um tratamento aqui, o node code.
...
![imagem dentro do agente](../assets/imagens/agente-registro-dentro.png)


Entao o Agente Registro manda para tabela Info_Presupuesto pagina Momentaneo com estes parametros


![imagem info_presupuesto](../assets/imagens/info_presupuesto.png)


# SUBWORKFLOW CONFIRMAR PRESUPUESTO


![imagem subworkflow confirmar](../assets/imagens/subworkflow-confirmar.png)
...
![imagem node code](../assets/imagens/code-01-externo-confirma.png)
...
![imagem doc template](../assets/imagens/template.png)
...
![imagem exemplo de como fica o documento](../assets/imagens/presupuesto.png)


Seguindo o fluxo, para converter o .docx em PDF. O node “Share File” dá o acesso ao HTTP Request que realiza a exportação. Depois, o “Upload File” guarda o arquivo na 
...
Por fim, se você leu [01 - visao geral](01-visao-geral.md) sabe que a tabela “Momentâneo” guarda apenas os dados temporários necessários para montar aquele orçamento. Esses dados não devem permanecer ali. Aqui está o motivo:
...
![imagem ultima etapa](../assets/imagens/guarda-no-historico.png)


Detalhe importante: O segundo node code também cria um id para cada orçamento para que seja salvo no “Histórico”.


![imagem historico](../assets/imagens/guarda-do-hitorico-interno.png)
