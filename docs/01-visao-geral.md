...
![imagem subworflow precio](../assets/imagens/subworklow-consulta.png)
...
3. Node Aggregate para voltar a juntar os dados. O motivo de fazer isso você vai entender no arquivo [02 - Node por Node](02-node-por-node.md)

4. Agente de IA que sua única função é registrar as informações que estarão presentes no documento em pdf do orçamento.

![imagem subworkflow confirma presupuesto](../assets/imagens/subworkflow-confirmar.png)
...
Aqui não tem nenhum Agente de IA para realizar o trabalho, mais detalhes sobre a configuração desses nodes você vai encontrar em [02 - Node por Node](02-node-por-node.md)
 Mas para dar um panorama geral, funciona assim: 
